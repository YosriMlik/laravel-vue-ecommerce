<template>
    <button type="button" class="btn btn-warning rounded-circle me-2" @click="visible=true">
    ...
    <form>
        <div class="card flex justify-content-center">
            <Dialog v-model:visible="visible">
                ...
                <br />
                <button type="submit" className="btn btn-outline-primary me-3" @click="modifierproduit">
                    <i class="fa-solid fa-floppy-disk me-1"></i>Enregister
                </button>
...
const getscategories = async () => {
    await api.get('http://localhost:8000/api/scategories')
    .then(res => {
...
const serverOptions = () => {
    return {
        ...
        process: (fieldName, file, metadata, load, error, progress, abort) => {
            ...
            axios.post('https://api.cloudinary.com/v1_1/dsvwfkqyk/upload', data)
